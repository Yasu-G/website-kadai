...
<!--ホーム**********************************************************-->
  <section id="home">
    ...
    <div id="top-img-div">
      ...
      <div id="top-img-pct">
        <!-- SP時画像 -->
        <img id="top-img-sp" src="<?php echo get_template_directory_uri(); ?>/images/SP-About.jpg" alt="About-img">
        <!-- PC時画像 -->
        <img id="top-img-pc" src="<?php echo get_template_directory_uri(); ?>/images/About.jpg" alt="About-img">
      </div>
    </div>
